    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        รายการกำลังซ่อมทั้งหมด<a class="date text-dark" id="Date"></a> <span class="co-sm right badge badge-warning">200 รายการ </span>
                    </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">รายการกำลังซ่อม</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
