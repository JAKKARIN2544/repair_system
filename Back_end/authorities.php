    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        เจ้าหน้าที่ทั้งหมด <a class="date text-dark" id="Date"></a> <span class="co-sm right badge badge-info">200 คน </span>
                    </h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card card-dark card-tabs">
                        <div class="card-header p-0 pt-1">
                            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true"><i class="fas fa-users"></i> เจ้าหน้าที่</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#custom-tabs-one-profile" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false"><i class="fas fa-edit"></i> เพิ่มเจ้าหน้าที่</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
