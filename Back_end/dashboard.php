  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-2 text-danger" style="font-size: 30px"><i class="nav-icon fas fa-tachometer-alt"></i> DASHBOARD OVERVIEW</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">
                <div class="d-flex">
                  <p class="d-flex flex-column">
                    <span class="text1 text-bold text-lg">18,230.00 <a class="text1">รายการ</a></span>
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    <div class="product-img">
                      <img src="../src/dist/img/default-150x150.png" alt="Product Image" class="img-size-50">
                    </div>
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="" class="product-title">
                        Xbox One <span class="badge badge-danger float-right">ยกเลิกซ่อม</span></a>
                      <span class="product-description">
