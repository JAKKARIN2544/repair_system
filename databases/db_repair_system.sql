...
--
-- Host: localhost
-- Generation Time: Jul 12, 2021 at 03:42 AM
...
CREATE TABLE `tb_authorities` (
  ...
  `aut_fristname` varchar(200) NOT NULL,
  `aut_lastname` varchar(200) NOT NULL,
  `aut_gender` varchar(10) NOT NULL,
  `aut_phone` varchar(10) NOT NULL,
  `aut_position` text NOT NULL
...
INSERT INTO `tb_user` (`id`, `email`, `username`, `password`, `fname`, `lname`, `gender`, `phone`, `housenumber`, `moo`, `provinces`, `amphures`, `districts`, `zipcode`, `level`) VALUES
('AD336444', 'super.admin@hotmail.com', 'admin123', '01488dd067097083f80f32761c0ad802', 'super', 'admin', 'ชาย', '0917422993', '155/5', '3', '11', '137', '200201', '20170', 'admin'),
('MB738643', 'member.user@gmail.com', 'member123', '703e2e21229528eb0c22f6d576ea3c2b', 'member', 'user', 'ชาย', '0999900099', '222/22', '2', '8', '110', '170204', '16130', 'member');
...
--
-- Indexes for table `tb_authorities`
--
